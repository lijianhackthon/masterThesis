...
\chapter{声学模型训练}
在\ref{acoustic model introduction}中，已经介绍了声学模型在语音识别中的作用，以及如何使用声学模型计算似然概率$P(O|\Omega)$。本章主要介绍声学模型参数估计的问题，包括传统的GMM-HMM模型和目前广泛使用的DNN-HMM模型。
\section{传统的GMM-HMM方法}\label{acousticmodel}
